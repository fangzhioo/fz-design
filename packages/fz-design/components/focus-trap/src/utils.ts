...
import { FOCUSOUT_PREVENTED, FOCUSOUT_PREVENTED_OPTS } from './constants'
...
export const isHidden = (element: HTMLElement, container: HTMLElement): boolean => {
...
export const getEdges = (container: HTMLElement): [HTMLElement|undefined, HTMLElement|undefined] => {
...
const createFocusableStack = (): any => {
  ...
  const remove = (layer: FocusLayer): void => {
    stack = removeFromStack(stack, layer)
    stack[0]?.resume?.()
  }
