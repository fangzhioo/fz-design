...
const getMarkStyle = (): CSSProperties => {
...
const destroyWatermark = (): void => {
  if (watermarkRef.value) {
    watermarkRef.value.remove()
    watermarkRef.value = undefined
  }
}
const appendWatermark = (base64Url: string, markWidth: number): void => {
...
useMutationObserver(containerRef as any, onMutate, {
  attributes: true
})
</script>
