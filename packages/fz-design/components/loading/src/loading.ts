...
import type { LoadingOptionsResolved } from './interface'
import {
  useNamespace,
  useZIndex,
...
export function createLoadingComponent (options: LoadingOptionsResolved): any {
                ...
                createVNode(
                  'div',
                  {
                    ...
                    class: [
                      ns.b('mask'),
                      data.customClass,
                      data.fullscreen ? ns.is('fullscreen') : ''
                    ]
                  },
                  [
                    h(
