...
const ComponentPrefix = 'Fz';
const ComponentPrefixClass = ComponentPrefix.toLowerCase() ? `${ComponentPrefix.toLowerCase()}-` : '';
...
module.exports = async () => {
  ...
  meta.compPrefix = ComponentPrefix;
  meta.compPrefixClass = ComponentPrefixClass;
  return meta;
};
