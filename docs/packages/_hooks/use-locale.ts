...
import { FZ_LOCALE_INJECT_KEY } from 'packages/_utils/constants';
import {
  computed,
  getCurrentInstance,
  inject,
...
import English from 'packages/_locale/lang/en';
...
export const useLocale = () => {
  return inject<LocaleContext>(
    FZ_LOCALE_INJECT_KEY,
    cache || localeProviderMaker(English),
  );
};
