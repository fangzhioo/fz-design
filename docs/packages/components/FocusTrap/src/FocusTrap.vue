...
<script lang="ts">
import { EVENT_CODE, FZ_FOCUS_TRAP_INSTANCE_INJECT_KEY } from '@fzui/constants';
import { useEscapeKeydown } from '@fzui/hooks';
import { isNil, isString, obtainAllFocusableElements } from '@fzui/utils';
import { defineComponent, nextTick, onBeforeUnmount, onMounted, provide, ref, unref, watch } from 'vue';
import { focusTrapProps, focusTrapEmits, FOCUS_AFTER_TRAPPED, FOCUS_AFTER_TRAPPED_OPTS, FOCUS_AFTER_RELEASED } from './FocusTrap';
import { focusableStack, focusFirstDescendant, FocusLayer, getEdges, ON_RELEASE_FOCUS_EVT, ON_TRAP_FOCUS_EVT, tryFocus } from './utils';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    provide(FZ_FOCUS_TRAP_INSTANCE_INJECT_KEY, {
